...
**Status:** decided (2026-09-12): fix as its own task, right after P1.7 finishes — Minh confirmed it blocks building a full melody and wants it prioritized, not deferred further. Not fixed in P1.7 itself (out of scope: layout/type/color/spacing only, no functional changes).
